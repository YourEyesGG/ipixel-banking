...
Config.ATM = {
    ...
    {id = 277, x = 814.84,  y = -279.4,  z = 66.48},
    {id = 277, x = -821.64,  y = -1081.92,  z = 11.12},
    {id = 277, x = 377.76,  y = -1509.76,  z = 29.28},
    {id = 277, x = 418.96,  y = -991.28,  z = 29.32},
    {id = 277, x = 260.7,  y = -756.62,  z = 30.82},
    {id = 277, x = 269.57,  y = -753.51,  z = 34.64},
}
